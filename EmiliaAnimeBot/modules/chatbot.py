...
# AI module using Intellivoid's Coffeehouse API by @doreamonfans1
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows Suneo to talk and provides a more interactive group chat experience.
...
dispatch.add_handler(REMOVE_CHAT_HANDLER)
dispatch.add_handler(CHATBOT_HANDLER)
dispatch.add_handler(LIST_CB_CHATS_HANDLER)
